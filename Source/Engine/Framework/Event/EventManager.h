...
#define EVENT_SUBSCRIBE(id, function) afro::EventManager::Instance().Subscribe(id, this, std::bind(&function, this, std::placeholders::_1))
#define EVENT_UNSUBSCRIBE(id) afro::EventManager::Instance().Unsubscribe(id, this)
