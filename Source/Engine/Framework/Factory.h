...
#define CREATE_CLASS_BASE(classbase, classname) afro::Factory::Instance().Create<afro::classbase>(classname);
#define INSTANTIATE(classbase, classname) afro::Factory::Instance().Create<afro::classbase>(classname);
